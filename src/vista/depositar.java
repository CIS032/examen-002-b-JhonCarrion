...
public class depositar extends javax.swing.JDialog {
     ...
     */
    public depositar(java.awt.Frame parent, boolean modal, String tip, Cuenta c) {
        super(parent, modal);
        initComponents();
        cu = c;
        tipo = tip;
    ...
    private void btn_DepositarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_DepositarActionPerformed
        ...
        switch (this.tipo) {
            case "Cuenta Ahorro":
                Banco.editar(pos, new CuentaAhorro(cu.getCliente(), cu.getTipoCliente(), cu.depositar(Double.parseDouble(ftxt_Monto.getText().replace(",", "."))), cu.getTasaInteres()));
                break;
            case "Cuenta Hipoteca":
                Banco.editar(pos, new CuentaHipoteca(cu.getCliente(), cu.getTipoCliente(), cu.depositar(Double.parseDouble(ftxt_Monto.getText().replace(",", "."))), cu.getTasaInteres()));
                break;
            case "Cuenta Prestamo":
                Banco.editar(pos, new CuentaPrestamo(cu.getCliente(), cu.getTipoCliente(), cu.depositar(Double.parseDouble(ftxt_Monto.getText().replace(",", "."))), cu.getTasaInteres()));
                break;
            default:
                break;
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                depositar dialog = new depositar(new javax.swing.JFrame(), true, null, null);
